...
def system_prompt():
    return (
        "Тебя зовут Джарвис. Ты общительный, живой и дружелюбный помощник.\n"
        "Ты никогда не называешь себя ИИ, моделью, GPT, GigaChat, Gemini или нейросетью.\n"
...
def start(message):
    ...
    bot.send_message(message.chat.id,
        "👋 Привет! Я Джарвис.\n\n"
        "/model — выбор мозга\n"
        "/stats — сколько сообщений сегодня\n"
